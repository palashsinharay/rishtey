...
/* function imageupload($a_id, $m_id){
 ...
 public function getPidToName($pid){
    ...
    function chkProfileExists() {
        ...
        $sqlChkProfileExists = "SELECT rp.fname, pr.* FROM fb_user_master AS fum
        ...
        if (count($resultChkProfileExists) > 0){
			...
			echo '1'.'##'.'<p class="errors mrgn-t20"><strong>A profile for '.$resultChkProfileExists[0]['fname'].' has already been created by his/her '.$resultGetRelationName[0]['relation'].' '.$resultGetGuardianName[0]['fullname'].'. You can either: </strong></p>
    ...
    function chkRcUser() {
        ...
        if (count($resultchkRcUser) > 0) {
			...
			if($_POST['inviteFriends']==''){
				$this->email->message('<p>To create a profile, please visit the following link:</p><p><a href="' . base_url() . '/sendmessage/index/' . $_POST['otherfrFbUserId'] . '">RishteyConnect</a></p>');
			}elseif($_POST['inviteFriends']==1){
				$this->email->message('<p><a href="' . base_url() . '/recommendation/index/' . $_POST['otherfrFbUserId'].'/'.$_POST['fbUserId'] . '">RishteyConnect</a></p>');
			}elseif($_POST['inviteFriends']==2){
				$this->email->message('<p>To create a profile, please visit the following link:</p><p><a href="' . base_url() . '/sendmessage/index/' . $_POST['otherfrFbUserId'] . '">RishteyConnect</a></p>');
			}else{
				//do nothing
...
//this function will send mail to existing guardian
    function sendMailToGuardian() {
        ...
        if (count($resultsendMailToGuardian) > 0) {
		    ...
		    $this->email->message('<p><a href="' . base_url() . '/facebooker">RishteyConnect</a></p>');			
    ...
    function showlanding() {
      ...
      <div class="widget-private">
        <div class="widget-index">
          <div class="button-group"><a href="' . base_url() . '/facebooker" class="btn-home" title="Home"><span>Home</span></a><a href="#" class="btn-private active" title="Private"><span>Private</span></a><a href="#" class="btn-effective" title="Effective"><span>Effective</span></a><a href="#" class="btn-simple noMargin" title="Simple"><span>Simple</span></a></div>
      ...
      <div class="widget-private min-height200">
        <div class="widget-index">
          <div class="button-group"><a href="' . base_url() . '/facebooker" class="btn-home" title="Home"><span>Home</span></a><a href="#" class="btn-private" title="Private"><span>Private</span></a><a href="#" class="btn-effective active" title="Effective"><span>Effective</span></a><a href="#" class="btn-simple noMargin" title="Simple"><span>Simple</span></a></div>
          <div class="slide-container">
            <div class="home-slider">
      ...
      <div class="widget-private min-height200">
        <div class="widget-index">
          <div class="button-group"><a href="' . base_url() . '/facebooker" class="btn-home" title="Home"><span>Home</span></a><a href="#" class="btn-private" title="Private"><span>Private</span></a><a href="#" class="btn-effective" title="Effective"><span>Effective</span></a><a href="#" class="btn-simple noMargin active" title="Simple"><span>Simple</span></a></div>
          <div class="slide-container">
            <div class="home-slider">
    ...
    function deleteBiodata() {
		...
		@unlink("/var/www/rishtey-connect/application/files/candidate_biodata/".$rp['biodata']);
    ...
    public function AbuseMailToAdmin($abused,$abuser) {
        ...
        $this->email->subject('Abuse report');
	...
	//function that send mail ongoing...
    ...
    public function recommendationGet($candidateFbid){
        ...
        foreach ($data as $key => $value) {            
            ...
            $imageSmall = "https://graph.facebook.com/$value[fb_user_id]/picture?width=107&height=107";
            $str = "<li><div class='left width50px'><img src=".$imageSmall." width='50' height='50' alt='' /></div><div class='left leftPadd widthComment'><strong>".$fbm->fname."'s <span>".$relationship.'</span> :</strong> '.$value[recommendation]."</div><div class='clear'></div></li>";
