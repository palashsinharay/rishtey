...
--
-- Host: localhost
-- Generation Time: Feb 06, 2013 at 01:07 PM
...
DROP TABLE IF EXISTS `extended_network`;
...
DROP TABLE IF EXISTS `fb_process`;
...
DROP TABLE IF EXISTS `fb_suggestion_list`;
...
DROP TABLE IF EXISTS `fb_user_master`;
...
DROP TABLE IF EXISTS `rc_caste_master`;
...
DROP TABLE IF EXISTS `rc_education_master`;
...
DROP TABLE IF EXISTS `rc_matched_profile`;
...
DROP TABLE IF EXISTS `rc_matched_profile_opposite_temp`;
...
DROP TABLE IF EXISTS `rc_matched_profile_temp`;
...
DROP TABLE IF EXISTS `rc_mtongue_master`;
...
DROP TABLE IF EXISTS `rc_profession_master`;
...
DROP TABLE IF EXISTS `rc_profiles`;
...
DROP TABLE IF EXISTS `rc_profile_picture`;
...
DROP TABLE IF EXISTS `rc_profile_preference`;
...
DROP TABLE IF EXISTS `rc_profile_relation`;
...
DROP TABLE IF EXISTS `rc_profile_show_interest`;
...
DROP TABLE IF EXISTS `rc_profile_update_message`;
...
DROP TABLE IF EXISTS `rc_recommendations`;
...
DROP TABLE IF EXISTS `rc_recommrelation_master`;
...
DROP TABLE IF EXISTS `rc_relation_master`;
...
DROP TABLE IF EXISTS `rc_religion_master`;
...
DROP TABLE IF EXISTS `rc_user_master`;
...
--
-- Table structure for table `takefile_exe`
--

DROP TABLE IF EXISTS `takefile_exe`;
CREATE TABLE IF NOT EXISTS `takefile_exe` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fb_user_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `takefile_exe`
--
